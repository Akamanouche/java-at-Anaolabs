...
/**
 * The persistent class for the V_SERVER_DET database table.
 * 
 */
@Entity
@Table(name="V_SERVER_DET")
@NamedQuery(name="VServerDet.findAll", query="SELECT v FROM VServerDet v")
public class VServerDet implements Serializable {
