...
/**
 * The persistent class for the V_LICENCE database table.
 * 
 */
@Entity
@Table(name="V_LICENCE")
@NamedQuery(name="VLicence.findAll", query="SELECT v FROM VLicence v")
public class VLicence implements Serializable {
