...
/**
 * The persistent class for the V_PRODUCT_INST_OPT database table.
 * 
 */
@Entity
@Table(name="V_PRODUCT_INST_OPT")
@NamedQuery(name="VProductInstOpt.findAll", query="SELECT v FROM VProductInstOpt v")
public class VProductInstOpt implements Serializable {
