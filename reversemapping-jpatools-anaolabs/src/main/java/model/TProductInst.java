...
/**
 * The persistent class for the T_PRODUCT_INST database table.
 * 
 */
@Entity
@Table(name="T_PRODUCT_INST")
@NamedQuery(name="TProductInst.findAll", query="SELECT t FROM TProductInst t")
public class TProductInst implements Serializable {
